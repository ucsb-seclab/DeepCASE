...
## Dataset
This research uses [two datasets](https://github.com/ucsb-seclab/DeepCase Datasets/) for its evaluation:
 1. Lastline dataset.
 2. [HDFS dataset](https://github.com/ucsb-seclab/DeepCase Datasets/).
